        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              ...
              {
                q: "What is the difference between Lorem Ipsum paragraphs sentences and words?",
                a: "The three generation modes in our Lorem Ipsum generator produce different types of placeholder text output. Paragraphs mode generates complete multi-sentence paragraph blocks — ideal for article mockups and blog post layouts. Sentences mode generates individual standalone sentences joined together — useful for shorter content blocks and UI components. Words mode generates a specified number of individual Lorem Ipsum words — perfect for testing button labels, short captions, tooltip text and other micro-copy elements. All three modes support the classic Lorem ipsum opening and the HTML paragraph tag format option.",
              },
            ].map(({ q, a }) => (
